...
/*
Se tiene el siguiente código de RTree (Disponible AQUÍ) funcional, que genera 25 objetos aleatorios y 
son insertados para producir un árbol de 3 niveles. Sin embargo, la función SPLIT no tiene una formulación 
decuada pues solo separa los datos de un nodo a ser dividido por la mitad de elementos y sin considerar 
información espacial. 
Implementar la versión QuadraticSplit (con todas sus funciones internas) y la versión LinealSplit (con todas sus funciones internas) 
y realizar una comparación entre los 3 diferentes abordajes, mostrando los diferentes MBRs producidos en cada una de las versiones.
Puede reutilizar todas las funciones disponibles del código adjuntado.
RECOMENDACIÓN (1): Comentar su código para ver las modificaciones realizadas
RECOMENDACIÓN (2): El código debe ser completamente funcional (no debe tener errores de compilación ni ejecución) para ser evaluado.
Texto de la respuesta Pregunta 7
